...
public class WebsSaludSeccion7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBackMenu = (Button)findViewById(R.id.btnSaludSeccion7BackMenu);
        ...
        btnBackMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(WebsSaludSeccion7.this);
                        ...
                        .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if(facebook.length() > 0 && instagram.length() > 0 && twitter.length() > 0){
                                    ...
                                    contacto_navbar = sharedPreferences.getString("web_salud_titulo_nav_contacto","");
                                    ...
                                    sociales_titulo = "";
                                    sociales_facebook = sharedPreferences.getString("web_salud_facebook_seccion_7","");
                                    sociales_instagram = sharedPreferences.getString("web_salud_instagram_seccion_7","");
                                    sociales_twitter = sharedPreferences.getString("web_salud_twitter_seccion_7","");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(WebsSaludSeccion7.this, WebsSaludSeccion6.class);
        startActivity(i);
        finish();
    }
}
