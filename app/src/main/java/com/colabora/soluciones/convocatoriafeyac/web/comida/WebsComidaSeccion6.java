...
import com.colabora.soluciones.convocatoriafeyac.web.aplicaciones.WebsAppsSeccion5;
...
public class WebsComidaSeccion6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBackmenu = (Button)findViewById(R.id.btnComidaSeccion6Finalizar);
        txtTituloNav = (TextInputEditText)findViewById(R.id.txt_web_comida_seccion6_navbar);
        ...
        txtTituloNav.setText(sharedPreferences.getString("web_comida_titulo_seccion_6",""));

        editNombre.setSelection(editNombre.getText().length());
        editDireccion.setSelection(editDireccion.getText().length());
        editCorreo.setSelection(editCorreo.getText().length());
                ...
                builder.setMessage("¿Estas seguro de finalizar?")
                        .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if(nombre.length() > 0 && direccion.length() > 0 && tituloNav.length() > 0){
                                    ...
                                    editor.putString("web_comida_titulo_seccion_6",tituloNav);
                                    ...
                                    Toast.makeText(getApplicationContext(), "Para continuar debes escribir los datos requeridos que llevará esta sección", Toast.LENGTH_LONG).show();
                                    return;
                                }
                                ...
                                specials_navbar = sharedPreferences.getString("web_comida_titulo_seccion_3","");
                                ...
                                about_imagen = sharedPreferences.getString("web_comida_img_seccion_4","");
                                about_navbar = sharedPreferences.getString("web_comida_titulo_seccion_4","");

                                menu_header = "Menu";
                                menu_navbar = sharedPreferences.getString("web_comida_titulo_seccion5","");
                                ...
                                contacto_navbar = sharedPreferences.getString("web_comida_titulo_seccion_6","");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(WebsComidaSeccion6.this, WebsComidaSeccion5.class);
        startActivity(i);
        finish();
    }
}
